      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">  
              <table id="staffmainte" class="table table-bordered table-hover table-striped">
                <thead>
                <tr>
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">  
              <table id="staffhistory" class="table table-bordered table-hover table-striped">
                <thead>
                <tr>
...
<script>
   $(function () {
    $('#staffhistory').DataTable()
    $('#staffmainte').DataTable()
    $('#example6').DataTable({
      'paging'      : true,
      'lengthChange': false,
      'searching'   : false,
