      ...
      <div class="box box-success">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="pieces">No. of Pieces</label>  
            <div class="col-md-4">
              <input id="pieces" name="pieces" value = "<?=set_value('pieces')?>" type="text" placeholder="Pieces" class="form-control input-md">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="destination">Destination</label>  
            <div class="col-md-4">
              <select id="destination" name="destination"  type="text" placeholder="Destination" class="form-control">
              <?php 
