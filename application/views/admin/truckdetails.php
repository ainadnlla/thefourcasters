              ...
              <table id="staff" class="table table-bordered table-hover">
                ...
                <?php foreach($trucks as $truck): ?>
                        <tr>
                            ...
                            <td>
                            <a href="<?= base_url().'admin/view/'.$truck->id?>" class="btn btn-primary" role="button">
                            <span class="glyphicon glyphicon-search" aria-hidden="true">
                            </span></a>

                            <a href="<?= base_url().'admin/edit/'.$truck->id?>"
                         class="btn btn-warning" role="button">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">
                            </span></a>
                            <?php $onclick = array('onclick'=>"return confirm('Are you sure?')");?>
                            <a href="<?=base_url('admin/delete/'.$trucks->id)?>" class="btn btn-danger" role="button">
