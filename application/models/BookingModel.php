...
//DROPDOWN
    ...
    function getDrivers(){
        ...
        $query = $this->db->query("SELECT id, fname, lname from driver where status= '1' AND DATE_FORMAT('$bookingdate', '%W') = weekday having COUNT('$drivername')<3 ORDER BY experience desc ", array('weekday'=>$weekdays));
             return $query->result();
    }
