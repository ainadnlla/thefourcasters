...
// GET
    ...
    public function getMain(){
        ...
        //ane
        $query = $this->db->query('SELECT maintenance.id, maintenance.supplier, maintenance.description, maintenance.purchased,maintenance.price,maintenance.unit,maintenance.quantity,maintenance.amount,maintenance.plate_no
        FROM truck  join maintenance on truck.plate_no =maintenance.plate_no ');
        return $query->result();
    }
