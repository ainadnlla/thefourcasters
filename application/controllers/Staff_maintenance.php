...
class Staff_maintenance extends CI_Controller {
    ...
    public function add(){
        ...
        $this->load->view('staff/maintenance/maintenanceadd');
    ...
    public function edit($id){
        ...
        $this->load->view('include/header', $data);
        $this->load->view('include/staff_header');
        $this->load->view('staff/maintenance/maintenanceedit',compact('main', 'amount'));
        $this->load->view('include/footer');
